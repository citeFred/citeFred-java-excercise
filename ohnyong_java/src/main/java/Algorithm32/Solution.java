...
public class Solution {
    ...
    public String Solution(String[][] quizNote) {
        int maxLength = 0; // 행마다 열의 갯수 최대 길이를 저장할 변수
        // 최대 길이 생성 -------가로로 몇개인지에 따라 못읽는 값이 생길 수 있어서 가장 긴것으로 모두 탐색하게함.
        for (int i = 0; i < quizNote.length; i++) {
            maxLength = Math.max(maxLength, quizNote[i].length);
        }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(sol.Solution(quizNote));
    }
}
